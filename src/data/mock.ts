...
export const events: Event[] = [
  ...
  },
  {
    ...
    venue: 'ZenSpace', venueId: 3, image: '',
...
export const feedPosts: FeedPost[] = [
  {
    ...
    userName: '小美妈妈',
    userAvatar: '',
    content: '今天上了一节林老师的体态矫正课，感觉整个人都挺拔了！老师教的日常坐姿小技巧特别实用，办公室久坐党的福音～',
    images: ['', ''],
    courseLabel: '核心床私教·体态矫正',
    coachName: '林悦然',
    likes: 28,
    liked: false,
    comments: [{ id: 1, userName: 'Linda', userAvatar: '', content: '太有用了！体态真的改善好多', time: '1小时前' }, { id: 2, userName: '阿杰', userAvatar: '', content: '我也是林老师的学员，超赞', time: '30分钟前' }],
    time: '2小时前',
  },
  {
    id: 2,
    userName: '跑者阿杰',
    userAvatar: '',
    content: '筋膜放松真的太重要了！今天刘教练帮我把小腿和腘绳肌彻底松了一遍，跑完马拉松的紧绷感终于缓解了。强烈建议跑友们定期做筋膜维护！',
    images: [''],
    courseLabel: '筋膜放松·深层松解',
    coachName: '刘凯文',
    likes: 15,
    liked: false,
    comments: [{ id: 1, userName: '小鹿', userAvatar: '', content: '筋膜放松真的很重要！', time: '2小时前' }],
    time: '5小时前',
  },
  {
    id: 3,
    userName: '静静',
    userAvatar: '',
    content: '产后修复第六节课啦，腹直肌从3指恢复到1指多了！苏老师超级温柔，每次上课都会根据我的状态调整训练强度，妈妈们千万别错过产后黄金修复期～',
    images: ['', '', ''],
    courseLabel: '上门私教·产后修复',
    coachName: '苏曼',
    likes: 42,
    liked: false,
    comments: [{ id: 1, userName: '苏曼', userAvatar: '', content: '加油！坚持就是胜利', time: '4小时前' }, { id: 2, userName: '小雪', userAvatar: '', content: '向你学习，我刚生完也要开始练了', time: '3小时前' }, { id: 3, userName: '静静回复苏曼', userAvatar: '', content: '谢谢苏老师鼓励！', time: '2小时前' }],
    time: '8小时前',
  },
  {
    id: 4,
    userName: '晨晨爸爸',
    userAvatar: '',
    content: '女儿坚持脊柱侧弯矫正半年了，今天复查度数从20度降到了14度！赵教练的专业和耐心我们都看在眼里，特意发帖感谢～青少年体态问题真的要早发现早干预！',
    images: ['', ''],
    courseLabel: '脊柱侧弯矫正·私教',
    coachName: '赵明哲',
    likes: 56,
    liked: false,
    comments: [{ id: 1, userName: '王芳', userAvatar: '', content: '早发现早干预太重要了，我女儿也有轻微的，准备带她去查一下', time: '8小时前' }, { id: 2, userName: '晨晨爸爸回复王芳', userAvatar: '', content: '建议尽快去看看，越早干预效果越好', time: '5小时前' }],
    time: '昨天',
  },
  {
    id: 5,
    userName: '小雨',
    userAvatar: '',
    content: '两个月瘦了5斤！周老师的核心轰炸课真的名不虚传，45分钟一节课下来衬衫能拧出水哈哈。课程氛围超级嗨，每次上完都感觉自己又变强了！',
    images: [''],
    courseLabel: '核心轰炸·燃脂塑形',
    coachName: '周思琪',
    likes: 33,
    liked: false,
    comments: [{ id: 1, userName: '晓雯', userAvatar: '', content: '太励志了！我也要开始练', time: '5小时前' }, { id: 2, userName: '小雨回复晓雯', userAvatar: '', content: '一起加油！坚持就有效果', time: '3小时前' }],
    time: '昨天',
  },
  {
    id: 6,
    userName: '小鹿',
    userAvatar: '',
    content: '工作压力大的时候来一节冥想课真的太治愈了！杨老师的声音超级温柔，引导呼吸和身体扫描的过程让我整个人都放松下来了。最近睡眠质量好了很多，墙裂安利给同样压力大的打工人～',
    images: ['', '', ''],
    courseLabel: '冥想与呼吸·身心平衡',
    coachName: '杨子萱',
    likes: 18,
    liked: false,
    comments: [{ id: 1, userName: 'David', userAvatar: '', content: '冥想真的能改善睡眠，我也是受益者', time: '1天前' }],
    time: '2天前',
  },
]
